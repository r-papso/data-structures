...
{
    /// <summary>
    /// Adapter used to add <see cref="INotifyCollectionChanged"/> and <see cref="ISaveable"/> behavior to <see cref="IBSTree{T}"/>
    /// </summary>
    /// <typeparam name="T">Type of elements in <see cref="IBSTree{T}"/></typeparam>
    public class TreeAdapter<T> : INotifyCollectionChanged, IEnumerable<T> where T : IKdComparable, ISaveable, new()
    {
        ...
        /// <see cref="IBSTree{T}"/>
        /// </summary>
        public IBSTree<T> Tree { get; private set; }
        ...
        /// <summary>
        /// Event invoked when either <see cref="IBSTree{T}"/> or <see cref="Found"/> is changed
        /// </summary>
        ...
        /// <summary>
        /// Constructs <see cref="TreeAdapter{T}"/> with specified <see cref="IBSTree{T}"/>
        /// </summary>
        /// <param name="tree"><see cref="IBSTree{T}"/></param>
        public TreeAdapter(IBSTree<T> tree) => Tree = tree;

        /// <summary>
        /// Gets all occurences of <paramref name="data"/> returned by <see cref="IBSTree{T}.Find(T)"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets all occurences between <paramref name="lowerBound"/> and <paramref name="upperBound"/> returned by <see cref="IBSTree{T}.Find(T, T)"/>
        /// </summary>
        ...
        /// <summary>
        /// Saves <see cref="IBSTree{T}"/> to CSV file
        /// </summary>
        ...
        /// <summary>
        /// Loads <see cref="IBSTree{T}"/> from CSV file
        /// </summary>
